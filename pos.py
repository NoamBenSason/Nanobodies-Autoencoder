...
if __name__ == '__main__':
    df = pd.DataFrame(columns=("sample", "cdr1_start", "cdr1_end", "cdr2_start", "cdr2_end", "cdr3_start", "cdr3_end"))
    i = 0
    for model in model_list:
        for sample in test_samples_list:
            ...
            df.loc[i] = [sample, cdr1_start,cdr1_end, cdr2_start, cdr2_end, cdr3_start, cdr3_end]
            i += 1
        break
    df.to_csv("RMSD_results_positions.csv",index=False, encoding="utf-8")
